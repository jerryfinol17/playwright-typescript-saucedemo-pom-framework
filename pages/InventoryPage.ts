...
export class InventoryPage extends BasePage {
    ...
    async resetApp(): Promise<void> {
        await this.clickElement(this.burgerMenuBtn, { force: false });
-
        await this.clickElement(this.resetLink, { force: true });

        await this.clickElement(this.crossBurgerBtn, { force: true });
    }
